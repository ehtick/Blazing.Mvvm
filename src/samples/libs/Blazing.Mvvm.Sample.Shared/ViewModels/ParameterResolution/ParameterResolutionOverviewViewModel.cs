...
/// <summary>
/// ViewModel for the ParameterResolution overview page that demonstrates MVVM navigation with parameter passing.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed partial class ParameterResolutionOverviewViewModel : ViewModelBase
{
    private readonly IMvvmNavigationManager _navigationManager;

    /// <summary>
    /// Initializes a new instance of the <see cref="ParameterResolutionOverviewViewModel"/> class.
    /// </summary>
    /// <param name="navigationManager">The MVVM navigation manager for type-safe navigation.</param>
    public ParameterResolutionOverviewViewModel(IMvvmNavigationManager navigationManager)
    {
